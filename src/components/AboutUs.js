    ...
    <Box>
      ...
      >
        ...
        >
          <Box maxW="800px">
            <Text>
              <strong>LNMHacks</strong> is the flagship annual hackathon of The
              LNM Institute of Information Technology. A 72-hour in-person
              hackathon with a wide range of tracks in the blockchain field,
              such as DeFi, DAOs, NFTs, and gaming, LNMHacks 5.0 expects the
              participation of innovators and developers from all over the
              nation.
            </Text>
            <Text mt="20px">
